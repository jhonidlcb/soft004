                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 h-full flex flex-col justify-center pt-16 sm:pt-20 md:pt-28">
                  ...
                  >
                    ...
                    <h1 className="font-sans text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-3 sm:mb-6 tracking-tight drop-shadow-xl leading-tight max-w-4xl mx-auto px-2">
                      Digitalizamos Negocios y Consultorios en Itapúa con Sistemas Profesionales
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-4 justify-center items-center max-w-md mx-auto mb-6 sm:mb-10 md:mb-12 px-4">
                      {heroSlides[currentSlide]?.buttonText && (
                        ...
                        >
                          Solicitar Diagnóstico Gratuito para mi Negocio en Itapúa
                        </Button>
                      )}
                      <Button
                        size="lg"
                    ...
                    {/* Trust Line */}
                    <p className="text-white/80 text-[10px] sm:text-xs md:text-sm mb-6 font-medium">
                      Empresa formal registrada en Paraguay • Emitimos factura electrónica legal • Soporte local en Itapúa
                    </p>
                    <p className="text-white/90 text-[10px] sm:text-xs md:text-sm mb-6 font-semibold -mt-4">
                      Atendemos presencialmente en Carlos Antonio López y trabajamos con negocios reales de Itapúa.
                    </p>
                  </motion.div>
      ...
      <section id="servicios" className="py-16 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 id="servicios" className="font-sans text-3xl sm:text-4xl font-bold text-foreground mb-4 tracking-tight">
              Soluciones Digitales para Negocios y Consultorios en Itapúa
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Soluciones tecnológicas completas: gestión de turnos, presencia web local, facturación electrónica SIFEN y soporte cercano en Itapúa
            </p>
          </motion.div>
                ...
                <Card className="h-full hover:border-primary/50 transition-all duration-300 hover:shadow-xl group hover-lift bg-card/80 backdrop-blur-sm border-border/50">
                  <CardHeader>
                    ...
                    <CardContent>
                      ...
                      {service.title === "Sistemas para Consultorios" && (
                        <div className="mb-6">
                          <a 
                            href="/sistema-de-turnos-en-itapua" 
                            className="text-primary font-semibold hover:underline flex items-center gap-1"
                          >
                            Sistema de Turnos en Itapúa
